...
//
//!Comment by Utkarsh (uk2051)
//!Bug issue and fix definition
//!Issue: Uninitialized variables being used
//!Detected using valgring valgrind --track-origins=yes --leak-check=full --show-leak-kinds=all  -s ./val_test02_solved tool, Error printed as: "Use of uninitialised value of size 8"
//!Fix: Either initialize the value to i, using the same trend or to 0. I will set it to zero. Assuming the the developer of the code took the assumption
//      that default value will be zero.
